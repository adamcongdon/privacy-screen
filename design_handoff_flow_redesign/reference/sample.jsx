...
const SAMPLE = {
  raw: `Customer Acme Corp opened a P1: their backup proxy srv-veeam01.acme.local (10.0.5.3) can't reach the repository at \\\\nas01\\backups.
...
Service account ACME\\svc-backup is failing auth.`,
  ...
  tokens: [
    ...
    { token: '{HOST_1}', cat: 'host', real: 'srv-veeam01.acme.local', count: 18 },
